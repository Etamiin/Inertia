...
public static class Logger
{
    ...
    {
        LogLine(content, _options.Line);
    }    
    public static void Warn(object content)
    {
        LogLine(content, _options.Warn);
    }    
    public static void Error(object content)
    {
        LogLine(content, _options.Error);
    }
    public static void Custom(object content, LogOptions.LogStyle logStyle)
    {
        LogLine(content, logStyle);
    }

    private static void LogLine(object content, LogOptions.LogStyle logStyle)
    {
