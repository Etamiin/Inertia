...
namespace Inertia
{
    ...
    /// </summary>
    public class SimpleReader : IDisposable
    {
        #region Static variables

        internal static Dictionary<Type, SimpleReturnAction<SimpleReader, object>> TypageDefinitons { get; private set; }
        ...
        /// </summary>
        public SimpleReader() : this(Encoding.UTF8)
        {
        }
        /// <summary>
        ...
        public SimpleReader(Encoding encoding)
        {
            m_encoding = encoding;
            ...
            TypageDefinitons = new Dictionary<Type, SimpleReturnAction<SimpleReader, object>>()
            {
        ...
        public SimpleReader(byte[] data) : this(data, Encoding.UTF8)
        {
        }
        /// <summary>
        ...
        /// <param name="data">The target byte array</param>
        /// <param name="encoding">Target <see cref="Encoding"/> for the reader</param>
        public SimpleReader(byte[] data, Encoding encoding) : this(encoding)
        {
            Fill(data);
        }
        ...
        /// <returns></returns>
        public SimpleReader Fill(byte[] data)
        {
            if (IsDisposed)
                throw new ObjectDisposedException(nameof(SimpleReader));

            var newLength = TotalLength + data.Length;
        ...
        /// </summary>
        /// <returns></returns>
        public SimpleReader RemoveReadedBytes()
        {
