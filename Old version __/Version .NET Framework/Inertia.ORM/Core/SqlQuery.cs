...
namespace Inertia.ORM
{
    public class SqlQuery<T> where T : Table
    {
        ...
        public long Average()
        {
            //TODO SqlQuery Average function
            return 0;
        }
        public long Max()
        {
            //TODO SqlQuery Max function
            return 0;
        }
        public long Min()
        {
            //TODO SqlQuery Min function
            return 0;
        }
        public long Round()
        {
            //TODO SqlQuery Round function (param int::nbr_decimal)
            return 0;
        }
        public long Sum()
        {
            //TODO SqlQuery sum function
            return 0;
        }
        //--
